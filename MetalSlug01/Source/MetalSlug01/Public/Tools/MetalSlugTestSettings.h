// ========================================================================
// MetalSlugTestSettings.h — 全局开发与测试配置中心
// ========================================================================
//
// 文件功能总览:
//   - 继承 UDeveloperSettings:自动注册到 Project Settings 侧边栏
//   - Config=Game + defaultconfig:配置存于 DefaultGame.ini,启动加载
//   - 所有 UPROPERTY 标记 Config:编辑器修改自动写入 .ini
//   - 生产环境默认值关闭:避免线上包携带开启的作弊功能
//
// 大厂架构角色 — 全局配置中心(单一真理源):
//   - 测试模式开关统一在此管理,GameFlow 启动时读取
//   - 与运行时配置(策划在 DataAsset 中调)分离 — 这是开发者/调试用配置
//   - 配置修改无需重编译,改完 .ini 重启游戏即可生效
// ========================================================================
