...
// ==========================================
// ActivityNavButton 头文件 — 活动导航按钮 Widget
// ==========================================
//
// 文件作用:
//   1. 声明 UActivityNavButton — 活动中心左侧导航按钮 Widget
//   2. 图标 + 标题 + 选中状态 + 红点
//   3. 点击后向父页面广播活动 ID
//
// 架构理念:
//   - 双委托: 普通委托 (Lambda 友好) + 动态委托 (蓝图友好)
//   - 单一职责: 一个小按钮管自己的样式
//   - 数据驱动: ActivityId 让父页面知道点击的是哪个活动
//   - 状态机: SetSelected / SetRedDot 都是单一职责方法
// ==========================================
