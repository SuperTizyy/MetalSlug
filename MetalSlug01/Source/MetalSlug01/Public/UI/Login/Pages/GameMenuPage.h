...
// ==========================================
// GameMenuPage 头文件 — 游戏主菜单页面
// ==========================================
//
// 文件作用:
//   1. 声明 UGameMenuPage — 游戏主菜单入口
//   2. 处理单人模式、双人模式、排行榜、活动中心及退出登录
//   3. 通过类引用 (TSubclassOf) 动态创建目标页面
//
// 架构理念:
//   - UI 解耦: 跳转目标动态创建, 不硬编码
//   - 蓝图可配置: 跳转目标在编辑器中配置
//   - 容错: BindWidgetOptional 让部分 UI 控件可以缺失而不报错
//   - 多人模式跳转: 走 UGameFlowSubsystem->TransitToState(MainLobby), 由 UIViewService 接管
// ==========================================
// 包含核心最小化头文件
