...
//
// 文件作用:
//   1. 实现 ULoginPage — 登录入口所有 UI 逻辑
//   2. 登录/注册/退出按钮
//   3. 调用 UAccountService 进行账号验证
//
// 大厂原则 (MVVM):
//   - View 完全无感知数据源: 只调 UAccountService
//   - 状态机驱动: GameFlowSubsystem 状态转换
//   - 强制鼠标控制权: 登录页面必须显示鼠标
//   - 密码暗文: EditableTextBox IsPassword=true
// ==========================================
// 包含当前类的头文件
