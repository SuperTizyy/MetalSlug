...
// ==========================================
// LANRoomPage 实现 — 局域网大厅与房间页面
// ==========================================
//
// 文件作用:
//   1. 实现 ULANRoomPage — 局域网大厅所有 UI 逻辑
//   2. 房间列表 + 自动刷新 + 加入房间
//   3. 创房弹窗: 命名/密码/模式/地图选择
//
// 大厂原则 (P0 架构升级):
//   - SessionManager 替代直读 OnlineSubsystem
//   - 防御性: 控件未绑 → Log Error
//   - 防呆: 先 RemoveAll 再 AddDynamic (避免重复绑定)
//   - 自动刷新: 3s 一次定时器, 不阻塞主线程
//   - 状态签名防闪烁: "房间名_人数_最大_状态" 字符串作为签名
// ==========================================
