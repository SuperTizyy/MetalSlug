...
// ==========================================
// RoomInsidePage 实现 — 房间内部 UI 页面
// ==========================================
//
// 文件作用:
//   1. 实现 URoomInsidePage — 房间 UI 所有逻辑
//   2. 玩家队伍管理 + 角色/武器选择 + AI 占位 + 聊天
//
// 大厂原则:
//   - 单一职责: 一个页面管一个 UI 模式
//   - 双数据流: 真人 (KnownPlayerStates) + AI 占位 (GM->PendingAIQueue) 独立
//   - 字段驱动: Snap.bIsAI (替代 StartsWith "[AI]" 字符串模糊判定)
